  ...
  return (
    <div className="div">
      <div className="div-oneBook">
        ...
        <div className="div-oneBook-description1">
          <div className="div-oneBook-description1-firstDescription">
          ...
          <div className="div-oneBook-description1-secondeDescription">
            <div className="div-oneBook-description1-secondeDescription-details">
              <h4>
